...
| Protocol | Account | Raw size | Compressed | Ratio | CU compress | CU decomp | Rent saved | Inactive accounts | Total recoverable |
|---|---|---|---|---|---|---|---|---|---|
| Drift | `User` | 4,376 B | 226 B | **21.9×** | 22,330 | 69,856 | 0.0289 SOL | 193,866 / 207,987 (93.2%) | **~5,605 SOL** |
| OpenBook v2 | `BookSide` | 90,952 B | 1,683 B | **54.1×** | ~300,000 | ~65,000 | 0.621 SOL | 228 markets / 271 (84.1%) | **~283 SOL** |
| Raydium CLMM | `TickArrayState` | 10,240 B | 190 B | **55.1×** | 90,940 | 64,604 | 0.0699 SOL | 324,670 TAs (153,496 / 168,744 pools inactive) | **~22,709 SOL** |
| Meteora DLMM | `BinArray` | 10,136 B | 1,606 B | **7.6×** | 136,990 | 61,960 | 0.0594 SOL | 331,732 BAs (125,156 / 139,185 pools inactive) | **~19,695 SOL** |

**Total across all protocols: ~48,292 SOL (~$4M)**
